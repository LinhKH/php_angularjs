...
return [
     ...
     */
    'table_columns' => [
        'emp_id', 'emp_nm', 'emp_kana_nm', 'emp_type_cd', 'aff_dept_cd', 'system_role_cd',
        'user_id', 'email', 'login_hash', 'agency_cd'
    ],
    /**
     ...
     */
    'login_hash_salt' => 'fdsfadnsklclanfnaernfninrjoaj9ncaruicfpsirfiuensi54tf50jeiorfhae',
    /**
