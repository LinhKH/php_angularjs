bookApp.directive('numbersSearchOnly', function () {
    return {
        require: 'ngModel',
...
bookApp.directive('telnoOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('telnoNumOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('zipCodeOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('numbersFaxOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('fileModel', ['$parse',
    function ($parse) {
        return {
            restrict: 'A',
...
bookApp.directive('bnList', function () {
...
bookApp.directive('numbersOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('numbersIntOnly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('trustedHtml', ['$sce',
    function ($sce) {
        return {
            require: 'ngModel',
...
bookApp.directive('repeatDone', function () {
...
bookApp.directive('select2', function ($timeout) {
    return {
        restrict: 'A',
        require: 'ngModel',
...
bookApp.directive('whenScrollEnds', ['blockUI',
    function (blockUI) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
...
bookApp.directive('viewDate', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('unicodeValue', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            element.bind('input', function (e) {
...
bookApp.directive('maxLength', function () {
    return {
        require: 'ngModel',
...
bookApp.directive('compile', ['$compile', function ($compile) {
    return function(scope, element, attrs) {
      scope.$watch(
        function(scope) {
...
bookApp.directive('clockpicker', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
        replace: true,
